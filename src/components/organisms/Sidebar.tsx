...
export function Sidebar() {
    ...
    return (
        <aside
            ...
            className={cn(
                "fixed left-0 top-0 z-40 h-screen bg-white dark:bg-neutral-950 border-r border-neutral-400 dark:border-neutral-800 transition-all duration-300 ease-in-out flex flex-col",
